# JSON stands for JavaScript Object Notation. It is a text format for storing and sending structured data. 
# It looks almost identical to Python dictionaries and lists, which makes it easy to work with in Python.
...
# [1, 2, 3]	         list
# "text"	           string (must use double quotes in JSON)
