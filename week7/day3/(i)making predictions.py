# Training a model is the setup. Prediction is the product. Once a model is trained, 
# you send it new inputs and it returns answers. This lesson covers how to predict for single inputs and batches,
#  how to save a trained model to disk so you do not retrain every time, and how to load it back for future use.

# .predict(X) takes a 2D array of inputs and returns predictions. Each row is one set of inputs.
