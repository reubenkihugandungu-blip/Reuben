...
# It misleads when classes are imbalanced 
# (90 out of 100 records belong to one class; always guessing that class gives 90% accuracy but the model learns nothing). 
