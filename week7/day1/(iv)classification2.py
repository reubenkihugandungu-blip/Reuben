...
# y will be used as the answer the model learns to predict
...
# Split both datasets using the same random state
X_two_train, X_two_test, y_train, y_test = train_test_split(X_two_features, y, test_size=0.25, random_state=42)
X_three_train, X_three_test, _, _ = train_test_split(X_three_features, y, test_size=0.25, random_state=42)
...
# Predict new days with three features
new_days = np.array([
    [8.0, 8, 85],
    [6.0, 5, 78],
    [9.0, 9, 88]
