...
# The classifier learns from 28 days of SMP training data. Features are sleep hours, water glasses, and bench press weight.
#  The label is whether steps reached 10,000 that day.
...
# Try This:
# Change n_estimators=100 to n_estimators=10 and re-run. Notice whether accuracy changes.
#  More trees generally means a more stable model, at the cost of slightly longer training time.