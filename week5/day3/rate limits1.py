# APIs limit how many requests you can make per minute, hour, or day. 
...
def fetch_member(member_id):
    ...
    member = mock_data.get(member_id)
    if member:
        member["steps_goal"] = member["steps"] >= 10000
    return member
...
for mid in member_ids:
    ...
    results.append(data)
    goal_status = " - Goal met" if data["steps_goal"] else ""
