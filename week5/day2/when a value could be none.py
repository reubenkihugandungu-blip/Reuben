...
for user in users:
    ...
    if workout is None:
        ...
        bench = workout.get("bench_press_kg", "not recorded")# safely get the "bench_press_kg" key from the workout dict. if the key doesnt exist use the default value "not recorded" instead of crashing
