"""
Biashara Loan - Movement Schedule Generator
Rima Sacco Limited
...
def generate_movement_schedule(terms: LoanTerms):
    ...
    # Standard amortization formula for equal monthly installment
    if monthly_rate == 0:
        installment = p / n
    else:
...
if __name__ == "__main__":
    # -----------------------------------------------------------
    # SINGLE INPUT POINT: change principal here (21,000 - 50,000)
    # -----------------------------------------------------------
    terms = LoanTerms(
        principal=35000,
        annual_rate_pct=20,
        term_months=6,
        loan_name="Biashara Loan",
    )
