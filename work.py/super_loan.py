"""
Super Loan - Movement Schedule Generator
Rima Sacco Limited

Reducing balance method.
Single input point: change `principal=` and `term_months=` in the
LoanTerms(...) call at the bottom (term: 24 to 36 months).
"""
...
if __name__ == "__main__":
    # -----------------------------------------------------------
    # SINGLE INPUT POINT: change principal (300,000+) and
    # term_months (24 for 2yrs, 36 for 3yrs) here
    # -----------------------------------------------------------
    terms = LoanTerms(
        principal=400000,
        annual_rate_pct=13,
        term_months=36,
        loan_name="Super Loan",
    )
